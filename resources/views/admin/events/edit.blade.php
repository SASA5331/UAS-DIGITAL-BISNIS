...
<button type="submit" class="px-8 py-4 bg-indigo-600 text-white rounded-2x1 font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition">Simpan Perubahan</button>
</div>
</form>
</div>
