        ...
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y border-t">
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6"><p class="font-bold text-slate-800">Donni Prabowo</p><p class="text-xs text-slate-500">donni@example.com</p></td>
                    <td class="px-8 py-6 font-medium text-slate-700">Jazz Night 2024</td>
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6"><p class="font-bold text-slate-800">Maya Sari</p><p class="text-xs text-slate-500">maya@example.com</p></td>
                    <td class="px-8 py-6 font-medium text-slate-700">AI & Future Workshop</td>
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    <td class="px-8 py-6"><span class="font-mono font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-lg text-sm">#TRX-99208</span></td>
                    <td class="px-8 py-6"><p class="font-bold text-slate-800">Budi Santoso</p><p class="text-xs text-slate-500">budi@example.com</p></td>
                    <td class="px-8 py-6 font-medium text-slate-700">Hackathon 2024</td>
                    <td class="px-8 py-6 text-sm text-slate-500">25 Mar 2024, 10:00</td>
                    <td class="px-8 py-6"><span class="px-3 py-1 bg-slate-100 text-slate-600 rounded-lg text-xs font-bold uppercase ring-1 ring-slate-200">Free</span></td>
